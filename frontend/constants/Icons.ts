...
export const Icons = {
  ...
  CHATBUBBLES_OUTLINE: 'chatbubbles-outline' as IconName,
  CHATBUBBLE_OUTLINE: 'chatbubble-outline' as IconName,
  ...
  CLOSE_CIRCLE_OUTLINE: 'close-circle-outline' as IconName,
  ...
  TRASH_OUTLINE: 'trash-outline' as IconName,
  FOLDER_OUTLINE: 'folder-outline' as IconName,
