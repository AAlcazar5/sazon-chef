...
export const CATEGORY_COLORS: Record<string, CategoryColor> = {
  ...
  Chinese: { bg: '#FFF3E0', bgDark: '#3E2B1A', text: '#7A2B00', textDark: '#FFF3E0', tint: 'rgba(255,243,224,0.15)', tintDark: 'rgba(62,43,26,0.3)', emoji: '🥡' },
  Indian: { bg: '#FFF8E1', bgDark: '#3E3A1A', text: '#7C4810', textDark: '#FFF8E1', tint: 'rgba(255,248,225,0.15)', tintDark: 'rgba(62,58,26,0.3)', emoji: '🍛' },
  ...
  Vietnamese: { bg: '#F1F8E9', bgDark: '#1F3A1A', text: '#3D5F22', textDark: '#F1F8E9', tint: 'rgba(241,248,233,0.15)', tintDark: 'rgba(31,58,26,0.3)', emoji: '🍲' },
  Ethiopian: { bg: '#FFF9C4', bgDark: '#3E3A10', text: '#7A5410', textDark: '#FFF9C4', tint: 'rgba(255,249,196,0.15)', tintDark: 'rgba(62,58,16,0.3)', emoji: '🫓' },
  Caribbean: { bg: '#E0F7FA', bgDark: '#1A3A3E', text: '#005A66', textDark: '#E0F7FA', tint: 'rgba(224,247,250,0.15)', tintDark: 'rgba(26,58,62,0.3)', emoji: '🥥' },

  // Meal types
  Breakfast: { bg: '#FFFDE7', bgDark: '#3E3A10', text: '#7C4810', textDark: '#FFFDE7', tint: 'rgba(255,253,231,0.15)', tintDark: 'rgba(62,58,16,0.3)', emoji: '🍳' },
  ...
  Snack: { bg: '#FFF3E0', bgDark: '#3E2B1A', text: '#7A2B00', textDark: '#FFF3E0', tint: 'rgba(255,243,224,0.15)', tintDark: 'rgba(62,43,26,0.3)', emoji: '🍿' },
  ...
  Soup: { bg: '#FFF8E1', bgDark: '#3E3A1A', text: '#7C4810', textDark: '#FFF8E1', tint: 'rgba(255,248,225,0.15)', tintDark: 'rgba(62,58,26,0.3)', emoji: '🍲' },
  ...
  'Low Carb': { bg: '#F1F8E9', bgDark: '#1F3A1A', text: '#3D5F22', textDark: '#F1F8E9', tint: 'rgba(241,248,233,0.15)', tintDark: 'rgba(31,58,26,0.3)', emoji: '🥑' },
  ...
  budget: { bg: '#FFF8E1', bgDark: '#3E3A1A', text: '#7C4810', textDark: '#FFF8E1', tint: 'rgba(255,248,225,0.15)', tintDark: 'rgba(62,58,26,0.3)', emoji: '💰' },
};
