...
`app/api/waitlist/route.ts` is a stub that validates with Zod and returns 200. Wire it to the Sazon backend (`backend/src/`) when the `WaitlistSignup` Prisma model lands — see `plans/launch.md#launch-marketing`.
