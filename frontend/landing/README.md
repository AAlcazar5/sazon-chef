...
| `public/mascot/sazon-{wave,thinking,chef-kiss}.svg` | Habanero mascot exports | `frontend/components/mascot/` |
| `public/lottie/{chef-kiss,sparkle}.json` | Lottie celebrations | `frontend/assets/lottie/` |
