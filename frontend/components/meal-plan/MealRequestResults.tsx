    ...
    >
      ...
      <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 8 }}>
        <View style={{ flex: 1, marginRight: 12 }}>
          <Text style={{ fontSize: 16, fontFamily: 'PlusJakartaSans_700Bold', color: textPrimary, marginBottom: 4 }}>
            {recipe.title}
          </Text>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            >
              <Text style={{ fontSize: 11, fontFamily: 'PlusJakartaSans_600SemiBold', color: textSecondary }}>{recipe.cuisine}</Text>
            </View>
        ...
        >
          ...
          <Text style={{ fontSize: 9, color: textSecondary, fontFamily: 'PlusJakartaSans_600SemiBold' }}>MATCH</Text>
        </View>
      </View>
      ...
      <View style={{ flexDirection: 'row', gap: 8 }}>
        ...
        >
          <Text style={{ fontSize: 14, fontFamily: 'PlusJakartaSans_700Bold', color: '#FFFFFF' }}>Add to Plan</Text>
        </HapticTouchableOpacity>
        <HapticTouchableOpacity
    ...
    <View>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16, gap: 8 }}>
        ...
        {generatedCount > 0 && (
          ...
          >
            <Text style={{ fontSize: 11, fontFamily: 'PlusJakartaSans_600SemiBold', color: isDark ? '#A5B4FC' : '#4F46E5' }}>
      ...
      >
        <Text style={{ fontSize: 14, fontFamily: 'PlusJakartaSans_600SemiBold', color: textSecondary }}>
