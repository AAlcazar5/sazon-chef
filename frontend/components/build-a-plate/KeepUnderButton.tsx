...
const STATE_VISUALS: Record<KeepUnderState, VisualConfig> = {
  idle: {
    ...
    label: 'Keep under…',
    a11y: 'Keep under — set upper bounds for any macro and let Sazon balance the plate within them',
  },
  loading: {
    bg: Pastel.sky,
    fg: '#1F4F7A',
  ...
  fit: {
    ...
    label: 'Under your caps',
    a11y: 'Plate stays under every cap you set',
  },
  impossible: {
    bg: Pastel.peach,
    fg: '#8a4a00',
    fgDark: '#FFD4A6',
    icon: 'alert-circle',
    label: 'Cannot stay under',
    a11y: 'Cannot stay under all caps — Sazon returned the closest plate',
  },
};
