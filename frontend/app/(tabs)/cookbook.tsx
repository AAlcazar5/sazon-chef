...
export default function CookbookScreen() {
  ...
  const cookbookFilterChipState = useCookbookFilterRowChips({
    filters: cookbookFilters,
    setFilters: setCookbookFilters,
  });
    ...
    <View style={{ flex: 1 }}>
      ...
      {viewMode === 'saved' && (
        <FilterRow
          ...
          activeChipIds={cookbookFilterChipState.activeChipIds}
          activeAdvancedCount={cookbookActiveFilterCount}
          onAdvancedFilterPress={() => setShowFilterModal(true)}
          onChipToggle={cookbookFilterChipState.onChipToggle}
        />
      )}
      ...
      {/* ROADMAP 4.0 A3-b — Discover view */}
      {viewMode === 'discover' && (
        <View testID="kitchen-view-discover" style={{ flex: 1 }}>
          <KitchenDiscoverView isDark={isDark} />
        </View>
      )}
