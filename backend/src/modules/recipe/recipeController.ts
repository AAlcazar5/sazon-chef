...
export const recipeController = {
  ...
  // ─── Collections (delegated to recipeCollectionsController) ────────────────
  getCollections: recipeCollectionsController.getCollections,
  createCollection: recipeCollectionsController.createCollection,
  updateCollection: recipeCollectionsController.updateCollection,
  deleteCollection: recipeCollectionsController.deleteCollection,
  moveSavedRecipe: recipeCollectionsController.moveSavedRecipe,
  togglePinCollection: recipeCollectionsController.togglePinCollection,
  reorderCollections: recipeCollectionsController.reorderCollections,
  duplicateCollection: recipeCollectionsController.duplicateCollection,
  mergeCollections: recipeCollectionsController.mergeCollections,
  ...
  // ─── Cookbook meta + cooking log (delegated to recipeCookbookController) ──
  getSavedMeta: recipeCookbookController.getSavedMeta,
  updateSavedMeta: recipeCookbookController.updateSavedMeta,
  recordView: recipeCookbookController.recordView,
  getRecentlyViewed: recipeCookbookController.getRecentlyViewed,
  recordCook: recipeCookbookController.recordCook,
  getCookingHistory: recipeCookbookController.getCookingHistory,
